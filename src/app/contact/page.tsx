    ...
    <div className="space-y-12 md:space-y-16">
            ...
            <CardContent>
              <Form {...form}>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="w-full md:w-auto bg-accent text-accent-foreground hover:bg-accent/90 transition-colors duration-150 ease-in-out group"
                  >
                    Send Message
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@hrcloudhub.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    info@hrcloudhub.com
                  </a>
      ...
      <section>
        ...
        <div className="aspect-video w-full bg-muted rounded-lg overflow-hidden">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.142293787104!2d-73.98785838459305!3d40.75889497932686!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c64801b9%3A0x86f6d9b4d5a8c37c!2sTimes%20Square!5e0!3m2!1sen!2sus!4v1678886"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
